    ...
    <div className="flex flex-col items-center justify-center min-h-screen p-4">
      ...
      <main className="flex-grow flex flex-col items-center justify-center text-center p-4 max-w-5xl w-full">
        ...
        <div className="mt-8 flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
          ...
          <button className="bg-transparent text-white font-semibold py-3 px-8 rounded-full border border-gray-400 hover:border-white transition-colors duration-300 transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-white focus:ring-opacity-50">
            Learn More
          </button>
        </div>
        ...
        <div className="mt-16 w-full max-w-5xl relative">
          <div className="relative w-full aspect-[16/9] bg-gray-800 rounded-3xl shadow-2xl overflow-hidden border border-gray-700 flex items-center justify-center">
            <img 
              src="/hero.png" 

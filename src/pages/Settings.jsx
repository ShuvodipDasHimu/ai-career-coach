        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="flex justify-between items-center mb-8">
            <div className="flex items-center space-x-3">
              <MdOutlineSettings className="text-indigo-500" size={32} />
            ...
            <div className="flex space-x-2">
              ...
              <motion.button 
                ...
                className="flex items-center space-x-2 bg-white text-gray-600 px-4 py-2 rounded-lg border border-gray-300 transition-colors"
              ...
              <AnimatePresence mode="wait">
                        ...
                        <div>
                          ...
                          <div className="flex items-center space-x-2">
                            <input
                              ...
                              className="flex-1 bg-gray-200 text-gray-900 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-400 border border-gray-300 disabled:opacity-60"
                            />
                            <motion.button
                        ...
                        <div className="md:col-span-2">
                          ...
                          <div className="flex items-start space-x-2">
                            <textarea
                              ...
                              rows="3"
                              className="flex-1 bg-gray-200 text-gray-900 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-400 border border-gray-300 disabled:opacity-60 resize-none"
                            />
                            <motion.button
                              onClick={() => handleEditToggle('bio')}
                              className="text-gray-600 hover:text-indigo-500 mt-2"
                              whileHover={{ scale: 1.1 }}
                              whileTap={{ scale: 0.9 }}
                            >
                              <BiEdit size={18} />
                ...
                {activeTab === 'notifications' && (
                  ...
                  >
                    <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-200">
                      <h3 className="text-xl font-semibold text-gray-900 mb-4 flex items-center space-x-2">
                        <FaBell className="text-indigo-500" size={20} />
                        ...
                        <div className="p-4 bg-gray-100 rounded-lg">
                          ...
                          <div className="space-y-3">
                            <div>
                              ...
                              <div className="relative">
                                <input
                                  ...
                                  className="w-full bg-white text-gray-900 rounded-lg px-4 py-2 pr-10 focus:outline-none focus:ring-2 focus:ring-indigo-400 border border-gray-300"
                            ...
                            <div>
                              ...
                              <input
                                type="password"
                                className="w-full bg-white text-gray-900 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-400 border border-gray-300"
                ...
                {activeTab === 'privacy' && (
                  ...
                  >
                    <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-200">
                      <h3 className="text-xl font-semibold text-gray-900 mb-4 flex items-center space-x-2">
                        <FaDatabase className="text-indigo-500" size={20} />

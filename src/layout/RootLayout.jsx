...
const RootLayout = () => {
  return (
    <div className="flex flex-col min-h-screen font-sans text-white bg-gray-900 bg-gradient-to-br from-gray-900 to-gray-800 overflow-x-hidden">
      <Sidebar />

      {/* Header section - responsive padding and max width for centering */}
      <header className="flex-shrink-0 w-full px-4 sm:px-6 md:px-8 ml-64">
      ...
      <footer className="flex-shrink-0 w-full px-4 sm:px-6 md:px-8 ml-64">
        <div className="w-full">
          <Footer />
        </div>
      </footer>
